...
import { PageLogin, PageLoginContent, CenteredCard, InputField, ErrorMessage, LinkOptions } from "../../components";
      ...
      <PageLoginContent>
        <CenteredCard title="Signup">
          <div className="flex flex-col gap-4">
            ...
            <LinkOptions options={[{ text: "Already have an account?", to: "/login" }]} />
          </div>
        </CenteredCard>
      </PageLoginContent>
    </PageLogin>
